...
JSE_TICKERS = [
    ...
    ("PPH.JO", "Pepkor Holdings", "Financials"),
    ...
    ("OCE.JO", "Octodec Investments", "Real Estate"),
    ...
    ("SPG.JO", "Super Group", "Consumer Staples"),
    ...
    ("MLE.JO", "Multichoice Group", "Consumer Discretionary"),
